...
\color{finishing}
% Eigentlicher Text:
\LM{} ist eine seit 1988 existierende Produktserie des Spielwarenherstellers \LE{} \cite[vgl.][21]{EV3RU}. 
...
und 3 für die 3 Stufe der \LM{}-Serie zusammen \cite[vgl.][21]{EV3RU}. \\
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.90\textwidth]{images/EV3-Overview.png}
...
ein Linux Betriebssystem und eine spezielle Firmware, die wie die auszuführenden Programme auf einem Flash-Speicher liegen \cite[vgl.][21]{EV3RU}. \\
...
genutzt werden \cite[vgl.][21]{EV3RU}.  \\
...
Motoren, die restlichen 4 Ports für die Abfrage von Sensorwerte \cite[vgl.][21]{EV3RU}.  \\
Der EV3-Stein besitzt an der Vorderseite ein LCD-Display zur Anzeige von Texten und Grafiken sowie  
6 Knöpfe für die Bedienung durch den Benutzer. Display und Knöpfe dienen zur Bedienung der Firmware sowie zur Tätigung von Einstellungen, können aber ebenso durch Programmen angesprochen und ausgewertet werden \cite[vgl.][21]{EV3RU}. 
\smallskip
\newline
Die folgende Auflistung zeigt einige Leistungsmerkmale des EV3-Steins \cites[vgl.][23\psq]{EV3RU}[32]{Roberta}.
\begin{itemize}
...
Bei beiden handelt es sich um Servormotoren mit integriertem Rotationssensor, welche von außen angesteuert und abgefragt werden können \cite[vgl.][92]{Roberta}. Die Motoren lassen sich sehr exakt steuern und ermöglichen so einen synchronen Betrieb mehrerer Motoren \cite[vgl.][29\psq]{EV3RU}.
\smallskip
\newline
...
aktiv als auch passiv betrieben werden und verfügt dafür über vier unterschiedliche Betriebsmodi  \cite[vgl.][101]{Roberta}:
\begin{itemize}
...
Der Senors verfügt über zwei unterschiedliche Betriebsmodi \cite[vgl.][32\psq]{EV3RU}:
\begin{itemize}
...
Kollision des Roboters mit einem Hindernis erkennen kann \cite[vgl.][33]{EV3RU}.
...
Integration von weiteren Sensoren etc. erleichter \cite[vgl.][23\psq]{Roberta}.
