...
Das Schwarmverhalten beschreibt die Verhaltensweise eines Schwarmes, welcher aus einer einheitlich formierten Tierart besteht. \footnote{\citep[vgl.][Schwarmverhalten]{Spektrum.SchwarmverhaltenKompaktlexikon}\label{note7}} Diese interagieren untereinander, um eine evulotionstechnische Überlegenheit durch das Bilden eines Schwarmes zu erhalten. Der Vorteil liegt dabei hauptsächlich im Schutz vor Fressfeinden des einzelnen Individuums des Schwarm, indem dieser nicht als Beutetier identifiziert werden kann. Andernfalls kann sich der Schwarm als solches effizienter gegenüber Fressfeinden behaupten und Jungtiere schützen. Zudem dient es einer Erleichterung der Fortpflanzung, da in einem Schwarm eine entsprechende Auswahl an Partnern besteht, um auch eine genetische Vielfalt zu erreichen.
...
\noindent
Ein Fischschwarm ist hierfür eines der bekanntesten Beispiele, indem die einzelnen Individuen des Schwarmes sich so verhalten, als würden sie wie ein einzelnes Tier agieren. Dabei setzt jeder Fisch feste Regeln um, die zur Umsetzung von einem Schwarmverhalten führen.\\
\begin{enumerate}
	\item Folge deinem Vordermann
	\item Behalte die Geschwindigkeit deiner Nachbarn bei
\end{enumerate}
\noindent
Das wichtigste hierbei ist der Schwellenwert der Steuerung. Da auch Fische aus der Reihe tanzen können und sich nicht in allen Punkten an Regeln halten existiert ein Schwellenwert für die allgemeine Steuerung des Schwarms, da das Schwarmverhalten sonst von Einzelnen dominiert werden kann. Dieser Schwellenwert liegt etwa bei fünf Prozent, woduch sich ein Schwarm durch Roboterfische lenken lassen kann, sobald dieser überschritten ist. Dieses Szenario lässt sich auf Menschen übertragen im Sinne von Veranstaltungen mit viel Menschen, um zu entscheiden an welchen Positionen SIcherheitspersonal platziert werden muss.

\noindent
Ein anderes Beispiel ist ein Termitenschwarm
